...
<html lang="en">
    ...
    <body>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-sm-8 col-sm-offset-2 text">
                            <h1><strong>用户登录</strong> Login </h1>
			                    ...
			                    <form role="form" action="login" method="post" class="login-form">
			                        ...
			                        <div class="form-group">
			                        	<div class="col-md-6">
			                        		...
			                        		<input type="text" name="vcode" placeholder="验证码..." class="form-password form-control" id="form-password">
				                        </div>
				                        <div class="col-md-6">
											<img src="VerifyCode" id="imgCode"
			                                alt="看不清楚？请点击刷新验证码" onclick="javascript:reloadCode();"/>    	
						                    
					                    </div>			                        
			                        </div>
			                        <div class="def-no1"></div>
			                        ...
			                        <div class="row">
			                        	...
			                        	<div class="col-md-6">
			                        		<button onclick="javascript:toRegister();" class="btn">注册</button>   
			                        	</div>
			                        </div>			                        		                       			                                             			
			                    </form>
		                    </div>
		...
		<script type="text/javascript">
			...
			function toRegister(){
				window.location=" <%=request.getContextPath()%>/user/toRegister ";
			}
			</script>
    </body>
